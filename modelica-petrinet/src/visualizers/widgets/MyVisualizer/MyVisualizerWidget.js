...
define(['jointjs','css!./styles/MyVisualizerWidget.css','css!jointjscss'], function (jointjs) {
    ...
    MyVisualizerWidget.prototype._initialize = function () {
        ...
        //=============================================================
        // define the operations when clicking transition 
        this._paper.on('element:pointerdown',function(elementView) {
            ...
            if (currentElement['attributes']['type'] === "pn.Transition") {
                ...
                if (isFirable(currentElement,this._arcs1,this._arcs2)) {
                    ...
                    //setTimeout(()=>{checkIfNoFirableTransitions(this._transitions,this._arcs1,this._arcs2);}, 0);
                }
                setTimeout(()=>{checkIfNoFirableTransitions(this._transitions,this._arcs1,this._arcs2);}, 0);
                //checkIfNoFirableTransitions(this._transitions,this._arcs1,this._arcs2);
            };
        });
    };
    ...
    //=============================================================
    // check if one transition is firable (enabled)
    ...
    MyVisualizerWidget.prototype.initNetwork = function (nums,pluginMessage) {
        ...
        console.info(message_places);
        console.info(message_transitions);
        ...
        setTimeout(()=>{checkIfNoFirableTransitions(this._paper._transitions,this._paper._arcs1,this._paper._arcs2);}, 0);
    };
    ...
    function checkIfNoFirableTransitions(transitions,arcs1,arcs2) {
        let flag = false;
        for (let i = 0; i < transitions.length; i++) {
            if (isFirable(transitions[i],arcs1,arcs2)) {
                flag = true;
